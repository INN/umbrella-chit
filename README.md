...
------------ | -------------
Name of new site directory: | chit
Blueprint to use (leave blank for none or use largo): | largo
Domain to use (leave blank for largo-umbrella.dev): | chit.dev
...
1. `cd` to the directory `chit/` in your VVV setup
2. `git clone git@github.com:INN/umbrella-chit.git`
3. Copy the contents of the new directory `umbrella-chit/` into `htdocs/`, including all hidden files whose names start with `.` periods.
	- the easy way to do this is: `rsync -rv umbrella-chit/ htdocs`
...
9. Search and replace 'chit.wpengine.com' --> 'chit.dev' in the db (options for doing this are covered in the [largo umbrella setup instructions](https://github.com/INN/docs/blob/master/projects/largo/umbrella-setup.md)
10. Optionally, you may want to pull down recent uploads so you have images, etc. to work with locally.
11. Visit chit.dev in your browser and you should see the site!
